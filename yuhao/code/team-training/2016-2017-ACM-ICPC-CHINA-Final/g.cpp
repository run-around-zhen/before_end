...
//		}
		int flag=1;
		int cnt1=n/2+n%2,cnt2=(n/2+n%2)/2+(n/2+n%2)%2,cnt3=n/2,cnt4=n/2/2+n/2%2;
		int flag1=0,flag2=0;
		for(int i=1;i<=n;i++){
			ll sum1=0,sum2=0;
...
//				dd(cnt1),dd(cnt2),dd(cnt3),de(cnt4);
				...
				if(flag1&&flag2){
					...
					if(i%2==0){
						if(ans[id[i]]=='1'){
							ss2=sum2=ff[cnt2+cnt3];
						}
						else if(ans[id[i]]=='0'){
							ss1=sum1=f[cnt2+cnt3];
						}
					}
					if(i%2==1){
						if(ans[id[i]]=='1'){
							ss2=sum2=ff[cnt1+cnt4];
						}
						else if(ans[id[i]]=='0'){
							ss1=sum1=f[cnt1+cnt4];;
						}
					}
				}
				if(ss1>=mx){
